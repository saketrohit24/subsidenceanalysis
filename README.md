...
---
## Future Work
While this project successfully subsidence into elastic and inelastic components, additional refinements and external factors could improve the analysis. Potential future directions include:
